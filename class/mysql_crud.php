...
class Database{
	...
	private $db_name = "db_hotel";	// Change as required

	/*
	private $db_host = "localhost";  // Change as required
	private $db_user = "nnpobrmy_david2022";  // Change as required
	private $db_pass = "nuevapassword2022";  // Change as required
	private $db_name = "nnpobrmy_db_hotel";	// Change as required
